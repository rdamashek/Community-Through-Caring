...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2023 at 11:44 PM
...
(1, 'admin@admin.com', 'Admin', '$2y$10$9MMJiM.HVXHf6r7xh52L/uay4KTeZ5WYZ3qibwoXUXU89j/sSCIcS');
...
--
-- Dumping data for table `area_shared`
--

INSERT INTO `area_shared` (`id`, `goal_id`, `address`, `city`, `state_province`, `zip`, `county`, `country`, `region`, `distance`, `measure`) VALUES
(1, 1, '', '', '', '', '', '', 'County', '0', NULL);
...
INSERT INTO `contact` (`id`, `name`, `email`, `number`, `details`, `is_public`, `date_created`) VALUES
(1, '', '', NULL, NULL, 0, '2023-02-06 19:10:32');
...
INSERT INTO `goals` (`id`, `member_id`, `name`, `type`, `description`, `cost`, `price`, `barter_details`, `delivery_type`, `deliery_location`, `photo`, `date_created`) VALUES
(1, 1, '', 'need', '', 'price', '', '', 'address', '', '0', '2023-02-06 19:10:32');
...
--
-- Dumping data for table `goal_contact`
--

INSERT INTO `goal_contact` (`id`, `goal_id`, `contact_id`) VALUES
(1, 1, 1);
...
INSERT INTO `member` (`id`, `name`, `email`, `photo`, `address`, `city`, `zip`, `password`, `auth_code`, `signup_date`, `phone`) VALUES
(1, 'Fakhar', 'fakhar.faai@gmail.com', '0', NULL, NULL, NULL, '$2y$10$Tu5G4iucwX808B8.6B51OugVMDaN86IKABMambbTBN5nHcnaPWaAK', NULL, '2023-02-06 19:09:26', '123456');
...
INSERT INTO `time_period` (`id`, `goal_id`, `type`, `start_date`, `day`, `end_date`) VALUES
(1, 1, '', '0000-00-00', 'null', '0000-00-00');
