...
<head>
    ...
    <title><?php echo get_lang('lang_offers_and_needs'); ?> | <?php echo get_lang('lang_sign_in'); ?></title>
...
<body style="background-color: #4caf9d;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url(); ?>welcome"><?php echo get_lang('lang_offers_and_needs'); ?></a>
    ...
    <div class="container text-center auth-container" style="margin-top: 25vh">
        ...
        ?>
            ...
            <div class="alert alert-warning" style="max-width: 500px;margin: auto;margin-bottom: 30px;">
                ...
                <strong><?php echo get_lang('lang_error'); ?></strong> <?php echo get_lang('lang_this_email_not_registered'); ?>
            </div>
        <?php
        } ?>
        <form action="<?php echo base_url('welcome/forgot_password_process') ?>" method="post">
            <div class="step">
                <h2 class="main-heading" style=""><?php echo get_lang('lang_forgot_password') ?></h2>
