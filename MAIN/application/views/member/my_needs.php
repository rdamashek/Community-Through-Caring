<div class="col-md-10 offset-md-2">
	<div class="container" style="background-color: white; margin-top: 75px; padding: 15px; border-radius: 25px;">
		<h2 style="padding-top: 50px" class="text-center"><?php echo get_lang('lang_all_need') ?>
		...
		<table class="table" id="goals_table">
			<thead>
				<tr>
					<th>#</th>
					<th><?php echo get_lang('lang_need_name') ?></th>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><a href="<?php echo base_url('member/edit_need/' . $goal['id']); ?>"><i class="fa fa-edit" style="color: #268171;"></i></a> &nbsp; <a onclick="delete_need(<?php echo $goal['id']; ?>);" href="#"><i class="fa fa-trash" style="color: #268171;"></i> </a></td>
					</tr>
				<?php
				}
				?>
