		...
		<div class="step">
			...
			<div class="spt-container need_steps">
				...
				<div class="single-step">
					...
					<input type="text" class="form-control main-single-inp" name="goal[name]" required="required" placeholder="<?php echo get_lang('lang_i_need_a_bike'); ?>">
					...
					<textarea class="form-control main-single-inp" name="goal[description]" placeholder="<?php echo get_lang('lang_description_about_something_i_need'); ?>" style="height: 80px;font-size: 17px; text-align: left"></textarea>
					...
					<input type="text" class="form-control main-single-inp" name="goal[price]" placeholder="$700"
						   >
					<span style="color: white; display: block; text-align: center;font-style: italic;font-size: 13px;"><?php //echo get_lang('lang_please_enter_the_budget_for_your_need');
					?></span> -->
					...
					<select onchange="show_options(this);" class="form-control main-single-inp" name="period[type]">
						...
						<option value="before" style="color: #fff; background-color: #44c0aa"><?php echo get_lang('lang_before'); ?></option>
						<option value="recurring" style="color: #fff; background-color: #44c0aa"><?php echo get_lang('lang_recurring'); ?></option>
						<option value="after" style="color: #fff; background-color: #44c0aa"><?php echo get_lang('lang_after'); ?></option>
					</select>
				...
				<div class="single-step" style="display: none">
					...
					<textarea id="address_inp_field" class="form-control main-single-inp address_inp_field" style="display:none;margin-top: 10px;height: 90px;" placeholder="<?php echo get_lang('create_need_page_please_enter_the_goal_delivery_location'); ?>" autocomplete="false" name="goal[deliery_location]"></textarea>
					...
					<div id="address_detail" style="display:none;">
						...
						<input type="text" class="form-control main-single-inp" name="address[zip]" placeholder="<?php echo get_lang('lang_zip_or_postal_code'); ?>">
						...
						<select class="form-control main-single-inp" name="address[region]">
							...
							<option><?php echo get_lang('create_need_page_select_address_region_world'); ?></option>
						</select>
		...
		if ($('#agree_check').is(':checked')) {
			...
			$.ajax({
				...
				success: function(data) {
					$("body").overhang({
						type: "success",
						message: "<?php echo get_lang('lang_need_posted_successfully'); ?>",
