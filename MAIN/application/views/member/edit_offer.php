			...
			<div class="spt-container offer_steps">
				...
				<div class="single-step">
					<h3 class="text-center">
						<?php echo get_lang('lang_update_your_offer'); ?>
					</h3>

					<input type="hidden" name="update_id" value="<?php echo $goal['id']; ?>">

					<input type="text" class="form-control main-single-inp" name="goal[name]" value="<?php echo $goal['name']; ?>" placeholder="<?php echo get_lang('lang_something_i_want_to_offer'); ?>">
					...
					<textarea class="form-control main-single-inp" name="goal[description]" placeholder="<?php echo get_lang('lang_description_about_something_i_want_to_offer'); ?>" style="height: 80px;font-size: 17px; text-align: left"><?php echo $goal['description']; ?></textarea>
					<span style="color: white; display: block; text-align: center;font-style: italic;font-size: 13px;"><?php echo get_lang('lang_what_would_you_like_to_offer'); ?></span>
				...
				<div class="single-step" style="display: none">
					...
					<select class="form-control main-single-inp goal_delivery_type" id="goal_delivery_type" name="goal[delivery_type]" value="<?php echo $goal['delivery_type']; ?>">
						...
						<option style="color: #fff; background-color: #44c0aa" value="virtual" <?php echo $goal['delivery_type'] == 'virtual' ? 'selected' : ''; ?>><?php echo get_lang('lang_virtual'); ?></option>
						<option style="color: #fff; background-color: #44c0aa" value="address" <?php echo $goal['delivery_type'] == 'address' ? 'selected' : ''; ?>><?php echo get_lang('lang_address'); ?></option>
					</select>
					...
					<textarea id="address_inp_field" class="form-control main-single-inp address_inp_field" style="display:none;margin-top: 10px;height: 90px;  display: <?php echo $goal['delivery_type'] == 'virtual' ? 'block' : 'none'; ?>" placeholder="<?php echo get_lang('lang_please_enter_the_offer_delivery_location'); ?>" autocomplete="false" name="goal[deliery_location]"><?php echo $goal['deliery_location']; ?></textarea>
