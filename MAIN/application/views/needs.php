...
<div class="container">
	<div id="tabs" style="margin-top: 150px">
		<ul>
			...
			<li><a href="#match-goals"><i class="fa-solid fa-heart-circle-check" style="color: #078a72;"></i> <?php echo get_lang('lang_favourites'); ?></a></li>
		</ul>
		...
		<div id="match-goals" style="">
			...
			<?php
				...
				echo '<h2 class="text-center">' . get_lang('lang_please_sign_in_to_add_view_your_favourites') . '</h2>';
