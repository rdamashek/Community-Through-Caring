...
<div class="col-md-10 offset-md-2">
	<div class="container " style="background-color: white; margin-top: 75px; padding: 15px; border-radius: 25px;">
		<h2 style="padding-top: 50px" class="text-center"><?php echo $language['my_needs_page_my_needs'] ?></h2>
		...
		<table class="table table-hover table-striped" id="goals_table" >
			...
			foreach ($goals as $goal){
				...
				<tr>
					...
					<td><a href="<?php echo base_url('admin/edit_need/'.$goal['id']); ?>" ><i class="fa fa-edit" style="color: #268171;"></i></a> &nbsp; <a onclick="delete_need(<?php echo $goal['id']; ?>);" href="#"><i class="fa fa-trash" style="color: #268171;"></i> </a></td>
				</tr>
				<?php
			}
			?>
...
if(value){
	window.location='<?php echo base_url('admin/delete_need/'); ?>'+$id;
}
  }
});
}
