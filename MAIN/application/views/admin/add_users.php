...
<div class="container text-center auth-container" style="margin-top: 25vh">
	<form action="<?php echo base_url('admin/login_post'); ?>" method="post" style="text-align: left; max-width: 500px; margin: auto; color: white">

		<div style="border: 1px solid silver; border-radius: 5px; padding: 15px">
			<div class="form-group">
				<label for="name">Name</label>
				<input type="name" class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="Enter your name">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" name="password" id="email" aria-describedby="helpId" placeholder="Enter your Password">
			</div>

			<div class="form-group">
				<input type="submit" class="btn btn-primary" name="submit" id="email" aria-describedby="helpId" value="Submit">
			</div>
		</div>
	</form>
</div>
