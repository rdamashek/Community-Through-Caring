			...
			<div class="spt-container need_steps">
				...
				<div class="single-step" style="display: none">
					...
					<div style="text-align: center;margin-top: 25px;">
						<label><input id="" name="contact[is_public]" value="1" type="checkbox" <?php echo ($contact['is_public'] == '1') ? 'checked="checked"' : ''; ?> style="height: 20px;width: 19px;position: relative;top: 3px;margin-right: 5px;"> <?php echo get_lang('lang_detailslang_display_my_contact_details_on_my_listing'); ?></label>
					</div>
